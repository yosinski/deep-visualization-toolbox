...
input_updater_sleep_after_read_frame = .10    # Sleep after reading frame
#input_updater_sleep_after_read_frame = 2    # Sleep after reading frame
input_updater_heartbeat_required = 5.0      # Thread dies after this many seconds without a heartbeat
...
help_pane_loc = (.1, .1, .8, .8)    # as a fraction of main window
...
caffevis_heartbeat_required = 3.0      # Thread dies after this many seconds without a heartbeat
